...
@section('content')
    <div class="container">
        <form action="/info/customer/update" method="post" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <div class="m-2">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                aria-describedby="nameHelp" placeholder="Enter Name" value="{{ $customerData->name }}">
                    ...
                    <div class="col-md-6 form-group">
                        <div class="m-2">
                            ...
                            @error('piTemplate')
                                <div id="piTemplateHelp" class="form-text text-danger">{{ $message }}
                                </div>
                            @enderror
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 form-group">
                        <div class="m-2">
                            <textarea name="info" id="personalInfo" cols="30" rows="10" value="{{ $customerData->personalData }}"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row col-md-12 ">
                        ...
                        <div class="col-md-6 row justify-content-center">
                            ...
                            <a href="/info/{{ $customerData->customUrl }}" class="btn btn-danger col-md-3 m-1">Cancel</a>
