...
<head>
    ...
    <title>Sign in - WhoICard - This is Enough!</title>
...
<body class=" d-flex flex-column" id="loginPageBody">
        ...
        <div class="container container-tight py-4">
            <div class="text-center mb-4">
                <a href="." class="navbar-brand navbar-brand-autodark"><img
                        src="{{ asset('storage/img/logo/logo.webp') }}" height="36" alt=""></a>
            </div>
            <div class="card card-md">
                <div class="card-body card-md-body">
                        ...
                        <div class="mb-2">
                            <label class="form-label">
                                ...
                                @if (Route::has('password.request'))
                                    <span class="form-label-description" href="{{ route('password.request') }}">
